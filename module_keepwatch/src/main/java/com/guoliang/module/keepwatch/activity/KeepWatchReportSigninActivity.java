...
import com.guoliang.module.keyevents.fragment.KeyEventReportFragment;
...
public class KeepWatchReportSigninActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void processIntent() {
        ...
        if ("qr".equals(mKeepWatchSigninInfo.getFinishType())) {
            String print = com.guoliang.module.fingerprint.Utils.getWifiCalculateFingerPrint();
            DistResult distResult = com.guoliang.module.fingerprint.Utils.getWifiDist(print, mKeepWatchSigninInfo.getDeskId());
            mKeepWatchSigninInfo.setMatchLevel(distResult.getStringMatchLevel());

            String wifiFingerPrintStr = com.guoliang.module.fingerprint.Utils.combineWifiStandardFingerPrint(print);
            String gpsFingerPrintStr = mLocation == null ? "" : com.guoliang.module.fingerprint.Utils.combineGpsStandardFingerPrint(mLocation);
            String fingerPrintStr = com.guoliang.module.fingerprint.Utils.appendOtherFingerPrint(wifiFingerPrintStr, gpsFingerPrintStr);
    ...
    public void onGetMessage(MessageEvent messageEvent) {
        if ("wifi_calculate_finger_print".equals(messageEvent.getMessage())) {
            String wifiFingerPrintStr = com.guoliang.module.fingerprint.Utils.combineWifiStandardFingerPrint(messageEvent.getValue());
            String gpsFingerPrintStr = mLocation == null ? "" : com.guoliang.module.fingerprint.Utils.combineGpsStandardFingerPrint(mLocation);
            String fingerPrintStr = com.guoliang.module.fingerprint.Utils.appendOtherFingerPrint(wifiFingerPrintStr, gpsFingerPrintStr);

            DistResult distResult = com.guoliang.module.fingerprint.Utils.getWifiDist(messageEvent.getValue(), mKeepWatchSigninInfo.getDeskId());
...
//            DistResult distResult = com.guoliang.module.fingerprint.Utils.getWifiDist(aa, 1500);
