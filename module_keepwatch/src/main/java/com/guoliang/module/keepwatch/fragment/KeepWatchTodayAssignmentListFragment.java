...
import com.guoliang.module.keepwatch.adapter.KeepWatchAssignmentListAdapter;
...
public class KeepWatchTodayAssignmentListFragment extends Fragment {
    private final static String TAG = "KeepWatchTodayAssignmentListFragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mV = inflater.inflate(R.layout.keepwatch_today_assignment_list_fragment, container, false);
        initViews(mV);
    ...
    private void initViews(View v) {
        ...
        mKeepWatchAssignmentListAdapter = new KeepWatchAssignmentListAdapter(mKeepWatchAssignmentList, "today");
        mAssignmentListView.setAdapter(mKeepWatchAssignmentListAdapter);
    }

    private void getTodayAssignmentList() {
