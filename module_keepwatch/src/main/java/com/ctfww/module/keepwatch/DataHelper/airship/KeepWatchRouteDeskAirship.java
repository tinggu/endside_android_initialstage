...
public class KeepWatchRouteDeskAirship {
    ...
    public static void synFromCloud() {
        ...
        long startTime = SPStaticUtils.getLong("keepwatch_route_desk_syn_time_stamp_cloud", CommonAirship.getDefaultStartTime());
        ...
        NetworkHelper.getInstance().synKeepWatchRouteDeskFromCloud(condition, new IUIDataHelperCallback() {
            ...
            public void onSuccess(Object obj) {
                ...
                SPStaticUtils.put("keepwatch_route_desk_syn_time_stamp_cloud", condition.getEndTime());
            }
