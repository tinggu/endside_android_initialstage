...
@Route(path = "/keepwatch/todayFinishStatusList")
public class TodayFinishStatusListActivity extends AppCompatActivity implements View.OnClickListener {
    private final static String TAG = "TodayFinishStatusListActivity";
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        setContentView(R.layout.today_finish_status_list_activity);
        initViews();
        setOnClickListener();
