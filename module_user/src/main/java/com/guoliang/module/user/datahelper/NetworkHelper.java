...
import com.guoliang.module.user.constant.UserSPConstant;
...
import com.guoliang.module.user.storage.sp.SPConstant;
...
public class NetworkHelper {
    ...
    private UserInfo processSuccessLogin(String data) {
        ...
        // 更新拦截设置
//        com.guoliang.commonlib.network.CloudClient.getInstance().init("http://39.98.147.77:8888");
