package com.guoliang.module.keyevents.window;
...
public class RecordVoicePopWindow extends PopupWindow {
    ...
    public RecordVoicePopWindow(Context context) {
        super(context);
        mContentView = LayoutInflater.from(context).inflate(R.layout.keyevents_pop_record_voice, null);
    ...
    public void showRecordingTipView() {
        ...
        mIvRcStatus.setImageResource(R.mipmap.keyevents_record_volume_microphone);
        mTvRcStatus.setVisibility(View.VISIBLE);
        mTvRcStatus.setText("手指上滑，取消发送");
    ...
    public void showRecordTooShortTipView() {
        mIvRcStatus.setVisibility(View.VISIBLE);
        mIvRcVolume.setVisibility(View.GONE);
        mIvRcStatus.setImageResource(R.mipmap.keyevents_record_volume_warning);
        mTvRcStatus.setText("录音时间太短");
    }
    ...
    public void showCancelTipView() {
        mIvRcStatus.setVisibility(View.VISIBLE);
        mIvRcVolume.setVisibility(View.GONE);
        mIvRcStatus.setImageResource(R.mipmap.keyevents_record_volume_cancel);
        mTvRcStatus.setVisibility(View.VISIBLE);
    ...
    public void updateCurrentVolume(int decibel) {
        switch (decibel / 5) {
            case 0:
                mIvRcVolume.setImageResource(R.mipmap.keyevents_record_volume_01);
                break;
            case 1:
                mIvRcVolume.setImageResource(R.mipmap.keyevents_record_volume_01);
                break;
            case 2:
                mIvRcVolume.setImageResource(R.mipmap.keyevents_record_volume_02);
                break;
            case 3:
                mIvRcVolume.setImageResource(R.mipmap.keyevents_record_volume_03);
                break;
            case 4:
                mIvRcVolume.setImageResource(R.mipmap.keyevents_record_volume_04);
                break;
            case 5:
                mIvRcVolume.setImageResource(R.mipmap.keyevents_record_volume_05);
                break;
            case 6:
                mIvRcVolume.setImageResource(R.mipmap.keyevents_record_volume_06);
                break;
            default:
                mIvRcVolume.setImageResource(R.mipmap.keyevents_record_volume_06);
        }
