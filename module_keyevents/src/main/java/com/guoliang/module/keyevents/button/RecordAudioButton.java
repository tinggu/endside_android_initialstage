package com.guoliang.module.keyevents.button;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                setBackgroundResource(R.drawable.keyevents_btn_chat_press_say);
                return true;
            ...
            case MotionEvent.ACTION_UP:
                ...
                setBackgroundResource(R.drawable.keyevents_btn_chat_press_normal);
                return true;
