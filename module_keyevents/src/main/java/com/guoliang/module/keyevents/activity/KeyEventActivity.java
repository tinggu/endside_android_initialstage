...
import com.guoliang.commonlib.utils.VoiceUtils;
...
import com.guoliang.module.keyevents.adapter.KeyEventTraceListAdapter;
...
//        EventBus.getDefault().removeStickyEvent(messageEvent);
    ...
    private void uploadKeyEventTrace(String userId, String status) {
        ...
        if ("end".equals(status)) {
            ...
            DistResult distResult = com.guoliang.module.fingerprint.Utils.getWifiDist(print, mKeyEvent.getDeskId());
