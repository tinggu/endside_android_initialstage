...
public class ReportKeyEventActivity extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void processTakePic() {
        ...
        Uri filePUri = FileProvider.getUriForFile(this,"com.guoliang.commonlib.utils" + ".myprovider", tempFile);
    ...
    private void processVideoRecord() {
        ...
        Uri fileVUri = FileProvider.getUriForFile(this,"com.guoliang.commonlib.utils" + ".myprovider", tempFile);
