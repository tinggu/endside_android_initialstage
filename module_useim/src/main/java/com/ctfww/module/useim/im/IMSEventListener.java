...
public class IMSEventListener implements OnEventListener {
    ...
    private IReceiveDataCallback callback;

    public IMSEventListener(String userId, String token, Context context, IReceiveDataCallback callback) {
        this.userId = userId;
        this.token = token;
    ...
    public void dispatchMsg(MessageProtobuf.Msg msg) {
        MessageProcessor.getInstance().receiveMsg(MessageBuilder.getMessageByProtobuf(msg), callback);
    }
