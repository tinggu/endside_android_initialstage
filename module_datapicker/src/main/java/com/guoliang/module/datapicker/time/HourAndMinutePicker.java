package com.guoliang.module.datapicker.time;
...
import com.guoliang.module.datapicker.R;
...
public class HourAndMinutePicker extends LinearLayout implements
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int halfVisibleItemCount = a.getInteger(R.styleable.HourAndMinutePicker_halfVisibleItemCount, 1);
        int selectedItemTextColor = a.getColor(R.styleable.HourAndMinutePicker_selectedTextColor, Color.BLACK); // getResources().getColor(R.color.com_ycuwq_datepicker_selectedTextColor)
