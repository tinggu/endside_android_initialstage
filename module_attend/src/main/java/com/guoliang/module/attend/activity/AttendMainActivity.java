...
public class AttendMainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.attend_main_activity);
        upgrade();
        initViews();
        setOnClickListener();
...
//    }
    ...
    private void initViews() {
        mViewPager = (ViewPager) findViewById(R.id.attend_viewpager);

        mStatisticsTab = (LinearLayout) findViewById(R.id.attend_statistics_ll);
        mKeepWatchTab = (LinearLayout) findViewById(R.id.attend_attend_ll);
        mMyTab = (LinearLayout) findViewById(R.id.attend_my_ll);

        mStatisticsImg = (ImageButton) findViewById(R.id.attend_statistics_image);
        mKeepWatchImg = (ImageButton) findViewById(R.id.attend_attend_image);
        mMyImg = (ImageButton) findViewById(R.id.attend_my_image);

        //数据的初始化
        mFragments = new ArrayList<Fragment>();
        Fragment mTab_01 = new AttendStatisticsFragment();
        Fragment mTab_02 = new AttendSigninFragment();
        Fragment mTab_03 = new AttendMyFragment();
...
//        com.ctfww.module.fingerprint.Utils.setDatabase(idList, fingerPrintList);
    ...
    private void resetImage() {
        mStatisticsImg.setImageResource(R.drawable.attend_statistics_normal);
        mKeepWatchImg.setImageResource(R.drawable.attend_attend_normal);
        mMyImg.setImageResource(R.drawable.attend_my_normal);
    }

    private void setSelectImage(int select) {
        switch (select) {
            case 0:
                mStatisticsImg.setImageResource(R.drawable.attend_statistics_pressed);
                break;
            case 1:
                mKeepWatchImg.setImageResource(R.drawable.attend_attend_pressed);
                break;
            case 2:
                mMyImg.setImageResource(R.drawable.attend_my_pressed);
                break;
            default:
                break;
        }
