...
import com.ctfww.module.baidumap.utils.CoordUtils;
...
//        }
        double lat = getIntent().getDoubleExtra("lat", 39.915071);
        double lng = getIntent().getDoubleExtra("lng", 116.403907);
        if (lat < 0.1 || lat > 89.9) {
            lat = 39.915071;
        }
        ...
        CoordUtils.Gps gps = CoordUtils.gps84_To_Gcj02(lat, lng);
        gps = CoordUtils.gcj02_To_Bd09(gps.getLat(), gps.getLng());
