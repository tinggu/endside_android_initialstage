package com.ctfww.module.baidumap.utils;
...
//        baiduMap.animateMapStatus(mapStatusUpdate);
    ...
    private static int getPtBmpId(int type) {
        int id = R.drawable.icon_map_center;
        switch (type) {
            case PT_TYPE_START:
                id = R.drawable.icon_map_start;
                break;
            case PT_TYPE_END:
                id = R.drawable.icon_map_end;
                break;
            case PT_TYPE_WAY:
