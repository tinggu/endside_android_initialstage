...
public class PickerScrollView extends View {
    ...
    private List<PickerScrollViewDataSupport.DatasBean> mDataList;
    /**
    ...
    public void setData(List<PickerScrollViewDataSupport.DatasBean> datas) {
        mDataList = datas;
    ...
    private void moveHeadToTail() {
        PickerScrollViewDataSupport.DatasBean datasBean = mDataList.get(0);
        mDataList.remove(0);
        mDataList.add(datasBean);
    }

    private void moveTailToHead() {
        PickerScrollViewDataSupport.DatasBean datasBean = mDataList.get(mDataList.size() - 1);
    ...
    public interface onSelectListener {
        void onSelect(PickerScrollViewDataSupport.DatasBean pickers);
    }
}

class PickerScrollViewDataSupport {
    /**
     * ret : 0
     * msg : succes,
