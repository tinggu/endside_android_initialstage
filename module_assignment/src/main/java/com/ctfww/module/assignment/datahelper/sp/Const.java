package com.ctfww.module.assignment.datahelper.sp;
...
public class Const {
    ...
    public static final String MODIFY_DESK = "modify_desk";

    public static final String FINISH_ROUTE_ASSIGNMENT_SYN = "finish_route_assignment_syn";
    public static final String ROUTE_ASSIGNMENT_SYN_TIME_STAMP_CLOUD = "route_assignment_syn_time_stamp_cloud";
    public static final String ADD_ROUTE = "add_route";
    public static final String MODIFY_ROUTE = "modify_route";
}
